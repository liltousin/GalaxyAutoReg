...
def main(driver: webdriver.Remote, tg_username: str, text_template: str, process_id: int):
    # надо добавть проверку и создание всех необходимых файлов и директорий для корректной работы
    sssm = SearchSpamStateMachine(driver, tg_username, text_template, process_id)
    sssm.start()
...
if __name__ == "__main__":
    ...
    main(get_driver(args), args.tg_username, args.text_template, args.process_id)
